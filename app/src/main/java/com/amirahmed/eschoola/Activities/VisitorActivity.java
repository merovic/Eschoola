...
import com.amirahmed.eschoola.Fragments.FilterFragment;
import com.amirahmed.eschoola.Fragments.LoginFragment;
import com.amirahmed.eschoola.Fragments.NavigationDrawerGuestFragment;
...
public class VisitorActivity extends AppCompatActivity implements NavigationDrawerCallbacks,BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener,SearchView.OnQueryTextListener,OnMapReadyCallback {
    ...
    ImageView culture,news,allschools,schoolsicon,mapicon;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(language==1)
        {
            ...
            searchView.setOnSearchClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    searchView.setBackgroundColor(Color.parseColor("#0D4874"));
                }
            });
        ...
        schoolsicon = findViewById(R.id.schoolsicon);
        ...
        schoolstab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                schoolstab.setBackgroundColor(Color.parseColor("#0D4874"));
                maptab.setBackgroundColor(Color.WHITE);
                schoolstext.setTextColor(Color.WHITE);
                maptext.setTextColor(Color.GRAY);

                Glide.with(VisitorActivity.this).load(R.drawable.school_map_blue_90x90).into(mapicon);
                Glide.with(VisitorActivity.this).load(R.drawable.schools_90x90).into(schoolsicon);
        ...
        maptab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                maptab.setBackgroundColor(Color.parseColor("#0D4874"));
                schoolstext.setTextColor(Color.GRAY);
                maptext.setTextColor(Color.WHITE);

                Glide.with(VisitorActivity.this).load(R.drawable.school_map_90x90).into(mapicon);
                Glide.with(VisitorActivity.this).load(R.drawable.schools_blue_90x90).into(schoolsicon);
